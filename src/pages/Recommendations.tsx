...
const allRecommendations = [
  ...
  {
    name: "Peter S.",
    role: "Managing Director, AutoParts Int.",
    text: "We've worked with many consultancies, but PINECO stands apart. Their hands-on approach and genuine commitment to our success made all the difference.",
    rating: 5,
    initials: "PS",
  },
  {
    ...
    text: "The leadership training programme was exactly what we needed. Our managers are now more confident, more strategic, and more effective.",
    rating: 5,
    initials: "ER",
  },
  {
    name: "Thomas B.",
    role: "Project Lead, Municipal Council",
    text: "PINECO's coordination of our smart city project was exemplary. Complex stakeholder management handled with professionalism and ease.",
    rating: 5,
    initials: "TB",
  },
];
  ...
  <div className="bg-background">
    ...
    <div className="pt-28 pb-12 container mx-auto px-4 lg:px-8 text-center">
      ...
      <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
        Don't just take our word for it — here's what our clients have to say about working with PINECO.
      </p>
    </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {allRecommendations.map((rec, i) => (
          <motion.div
            ...
            className="bg-card rounded-2xl p-8 card-elevated hover:card-elevated-hover transition-all duration-300"
          >
